					...
					<div class="col-xl-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
						<div class="widget widget_about me-2">
							<div class="footer-logo logo-white">
								<a href="index.html"><img src="<?= APP_URL ?>public/assets/clients/images/logo-white.svg" alt=""></a> 
							</div>
					...
					<div class="col-xl-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
						<div class="widget widget_post">
							...
							<ul>
								<li>
									<div class="dz-media">
										<img src="<?= APP_URL ?>public/assets/clients/images/category/pic8.jpg" alt="">
									</div>
								...
								<li>
									<div class="dz-media">
										<img src="<?= APP_URL ?>public/assets/clients/images/category/pic7.jpg" alt="">
									</div>
									<div class="dz-content">
								...
								<li>
									<div class="dz-media">
										<img src="<?= APP_URL ?>public/assets/clients/images/category/pic9.jpg" alt="">
									</div>
									<div class="dz-content">
				...
				<div class="row fb-inner wow fadeInUp" data-wow-delay="0.1s">
					...
					<div class="col-lg-6 col-md-12 text-end"> 
						<div class="d-flex align-items-center justify-content-center justify-content-md-center justify-content-xl-end">
							...
							<img src="<?= APP_URL ?>public/assets/clients/images/footer-img.png" alt="">
						</div>
					</div>
				</div>
			</div>
