					...
					<div class="col-lg-8">
						<div class="table-responsive">
							<table class="table check-tbl">
								...
								<tbody>
									<tr>
										<td class="product-item-img"><img src="<?= APP_URL ?>public/assets/clients/images/shop/product/dt5.png" alt="/"></td>
									...
									<tr>
										<td class="product-item-img"><img src="<?= APP_URL ?>public/assets/clients/images/shop/product/dt6.png" alt="/"></td>
