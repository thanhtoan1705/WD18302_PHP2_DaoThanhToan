								...
								<div class="swiper-wrapper" id="lightgallery">
									<div class="swiper-slide">
										<div class="dz-media DZoomImage">
											<a class="mfp-link lg-item" href="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" data-src="<?= APP_URL ?>public/assets/clients/images/products/baby-seat.png">
												<i class="feather icon-maximize dz-maximize top-right"></i>
											</a>
											<img src="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" alt="image">
										</div>
									</div>
									<div class="swiper-slide">
										<div class="dz-media DZoomImage">
											<a class="mfp-link lg-item" href="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" data-src="<?= APP_URL ?>public/assets/clients/images/products/baby-seat2.png">
												<i class="feather icon-maximize dz-maximize top-right"></i>
											</a>
											<img src="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" alt="image">
										</div>
									...
									<div class="swiper-slide">
										<div class="dz-media DZoomImage">
											<a class="mfp-link lg-item" href="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" data-src="<?= APP_URL ?>public/assets/clients/images/products/baby-seat3.png">
												<i class="feather icon-maximize dz-maximize top-right"></i>
											</a>
											<img src="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" alt="image">
										</div>
						...
						<div class="dz-content">
							<div class="dz-content-footer">
								<div class="dz-content-start">
									...
									<h4 class="title mb-1"><a href="shop-list.html"><?= $data['product']['name'] ?></a></h4>
							...
							<div class="meta-content m-b20 d-flex align-items-end">
								<div class="me-3">
									...
									<span class="price-num">$<?= $data['product']['price'] ?></span>
								</div>
							...
							<div class="btn-group cart-btn">
								<form action="<?= APP_URL ?>cart" method="post">
									...
									<input type="hidden" name="quantity" value="1"> <!-- You can dynamically set the quantity based on user input -->
							...
							<ul class="d-md-flex d-none align-items-center">
								...
								<li class="icon-bx-wraper style-3">
									<div class="icon-bx">
										<img src="<?= APP_URL ?>public/assets/clients/images/svg/icon-bx/box.svg" alt="/">
									</div>
									<div class="info-content">
							...
							<div class="row">
								<div class="col-lg-6 m-lg-b0 m-md-b30">
									<div class="section-head style-2 d-block">
										<h2 class="title">Fits Your Child</h2>
									...
									<div class="product-specification">
										...
										<ul>
											<li>Assembled Dimensions (L x W x H): <span>21.5" x 19" x 27"</span></li>
											<li>Assembled Product Weight: <span>25 lbs.</span></li>
										</ul>
									</div>
									<ul class="specification-list m-b40">
										<li class="list-info">Harness Mode - Rear-Facing<span>5-40 lbs</span></li>
										<li class="list-info">Harness Mode - Forward-Facing<span>25-65 lbs</span></li>
										<li class="list-info">Booster Mode - Harness + Booster<span>40-100 lbs</span></li>
										<li class="list-info">Booster Mode - Backless<span>n/a</span></li>
										<li class="list-info">Rear-Facing Child Max Height Capacity<span>43 in</span></li>
										<li class="list-info">Forward-Facing Child Max Height Capacity<span>54 in</span></li>
										<li class="list-info">Booster Child Height Capacity<span>38-57 in</span></li>
									</ul>
									<div class="product-media row g-xl-4 g-2 m-b40">
										<div class="col-md-3 col-3 col-sm-3 product-media-inner">
											<a href="shop-list.html" class="dz-media">
												<img src="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" alt="/">
											</a>
										</div>
										<div class="col-md-3 col-3 col-sm-3 product-media-inner">
											<a href="shop-list.html" class="dz-media">
									...
									<div class="product-info">
										<div class="product-info-inner">
											...
											<ul class="d-lg-flex d-block align-items-center">
												<li>
													<h6>Seatpad: <span>100% Polyester</span></h6>
												</li>
												<li>
													<h6>Insert: <span>100% Polyester</span></h6>
												</li>
											</ul>
										</div>
										<div class="product-info-inner">
											<h4 class="info-title">Chemical Statement</h4>
											<p class="info-text">The OneFit ClearTex All-In-One Car Seat is produced without the use of intentionally added fire retardant chemical treatments, PFAS, BPA and phthalates. </p>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="row">
										<div class="col-lg-6 col-md-6 m-sm-b20 m-b30">
											<a href="product-default.html" class="about-product-wrapper">
												<div class="producṭ-content bg-light">
													<h4 class="product-title">All-in-One Car Seat</h4>
										...
										<div class="col-lg-6 col-md-6 m-sm-b20 m-b30">
											<a href="product-default.html" class="about-product-wrapper">
												<div class="producṭ-content bg-light">
													<h4 class="product-title">Space-Saving Design</h4>
										...
										<div class="col-lg-6 col-md-6 m-sm-b20 m-b30">
											<a href="product-default.html" class="about-product-wrapper">
												<div class="producṭ-content bg-light">
													<h4 class="product-title">Easiest to Install Correctly</h4>
										...
										<div class="col-lg-6 col-md-6 m-sm-b20 m-b30">
											<a href="product-default.html" class="about-product-wrapper">
												<div class="producṭ-content bg-light">
													<h4 class="product-title">No Added Chemicals</h4>
													<p class="product-text">ClearTex products meet federal flammability standards without added chemicals</p>
												</div>
											</a>
										</div>
									</div>
									<div class="dz-product-media dz-media"><img src="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" alt="/"></div>
								</div>
							</div>
						</div>
											...
											<li class="comment even thread-even depth-1 comment" id="comment-2">
												<div class="comment-body">
													<div class="comment-author vcard">
														<img src="<?= APP_URL ?>public/uploads/images/<?= $data['product']['image'] ?>" alt="/" class="avatar">
