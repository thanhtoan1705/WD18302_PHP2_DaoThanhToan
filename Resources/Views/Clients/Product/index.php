			...
			<div class="container">
				<div class="row m-auto gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
							<div class="col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-sm-b0 m-b30">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?= APP_URL ?>public/assets/clients/images/shop/product/dt1.png" alt="image">			
										<div class="shop-meta">
							...
							<div class="col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-sm-b0 m-b30">
								<div class="shop-card">
									<div class="dz-media">
										<img src="<?= APP_URL ?>public/assets/clients/images/shop/product/dt2.png" alt="image">	
										<div class="shop-meta">
														<a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
															<i class="fa-solid fa-eye d-md-none d-block"></i>
															<span class="d-md-block d-none">Quick View</span>
