...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th1 05, 2024 lúc 09:57 AM
...
INSERT INTO `products` (`id`, `id_category`, `name`, `price`, `quantity`, `describe`, `view`, `status`, `delete`, `created_at`, `update_at`) VALUES
